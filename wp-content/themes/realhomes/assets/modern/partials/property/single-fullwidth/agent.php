                                ...
                                <form id="<?php echo esc_attr( $agent_form_id ); ?>"
                                    ...
                                    <div class="rh_agent_form__field rh_agent_form__textarea">
                                        ...
                                        <textarea rows="6" name="message" id="comment-<?php echo esc_attr( $agent_form_id ); ?>" class="required" placeholder="<?php esc_attr_e( 'Your Message', 'framework' ); ?>" title="<?php esc_attr_e( '* Please provide your message', 'framework' ); ?>"><?php
	                                        printf( esc_html__( 'Hello, I\'m interested in [%s]', 'framework' ), esc_html( get_the_title( get_the_ID() ) ) );
	                                        ?></textarea>
                                    </div>
                                    ...
                                    <div class="rh_agent_form__row">
                                        ...
                                        <div class="agent-form-contact-methods-wrapper">
                                            <button type="submit" name="submit" class="submit-button rh_btn rh_btn--primary btn-mail-now">
                                            ...
                                            <?php if ( isset( $args['agent_mobile'] ) && ! empty( $args['agent_mobile'] ) || isset( $args['agent_whatsapp'] ) && ! empty( $args['agent_whatsapp'] ) ) : ?>
		                                        <?php realhomes_property_agent_contact_methods( $args['agent_mobile'], $args['agent_whatsapp'], 'rh_btn rh_btn--primary submit-button' ); ?>
	                                        <?php endif; ?>
