	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .rhea-tabs-container .rhea-tabs-wrapper' => 'flex-basis: {{SIZE}}{{UNIT}}; max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .rhea-tabs-container .rhea-tabs-content-wrapper' => 'flex-basis: {{SIZE}}{{UNIT}}; max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
