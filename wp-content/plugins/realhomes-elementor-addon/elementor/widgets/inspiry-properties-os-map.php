...
class RHEA_Properties_OS_Map_Widget extends \Elementor\Widget_Base {
	...
	public function __construct( array $data = [], array $args = null ) {
		...
		$this->rhea_leaflet_scripts();
//		$this->rhea_leaflet_cluster_scripts();
	}
	...
	public function rhea_leaflet_scripts() {
		wp_enqueue_script( 'leaflet', 'https://unpkg.com/leaflet@1.3.4/dist/leaflet.js', array(), '1.3.4', true );
	}
//	public function rhea_leaflet_cluster_scripts() {
//		wp_enqueue_script(  'leaflet-cluster', RHEA_PLUGIN_URL . 'elementor/js/openstreetmap-cluster.js', array( 'leaflet' ), '1.4.1' );
//	}
		...
		if ( $map_properties_query->have_posts() ) {
			...
			if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
                ...
                <script type="application/javascript">
                    rheaLoadOSMap("<?php echo "rhea-" . $this->get_id(); ?>", <?php echo json_encode( $properties_map_data );?>);
                </script>
				<?php
			} else {
				?>
