...
//	$rhea_currency_position   = get_option( 'theme_currency_position' );
    ...
    >
        ...
        <input name="min-price" type="hidden" class="rhea_slider_value rhea_min_value" data-index="0"/>
        <input name="max-price" type="hidden" class="rhea_slider_value rhea_max_value" data-index="1"/>
        ...
        <div class="rhea_price_slider_wrapper" id="rhea_slider_<?php echo esc_attr( $the_widget_id ) ?>">
            ...
            <div class="rhea_price_range">
                ...
                <span class="rhea_price_display rhea_min_slide"
                      data-index="0"><?php echo rhea_get_custom_price( rhea_get_min_max_price( 'min' ) ) ?></span>
				<?php
                ...
                <span class="rhea_price_display rhea_max_slide"
                      data-index="1"><?php echo rhea_get_custom_price( rhea_get_min_max_price( 'max' ) ) ?></span>
            </div>
        </div>
