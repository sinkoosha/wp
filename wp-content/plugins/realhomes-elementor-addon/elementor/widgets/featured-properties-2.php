...
class RHEA_Featured_Properties_Two_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		if ( $featured_properties_query->have_posts() ) {
            ...
            $slideshow_speed = ( ! empty( $settings['ere_featured_properties_two_slideshow_speed'] ) ) ? $settings['ere_featured_properties_two_slideshow_speed'] : 4000;
            $slideshow_animation_speed = ( ! empty( $settings['ere_featured_properties_two_animation_speed'] ) ) ? $settings['ere_featured_properties_two_animation_speed'] : 2000;
            $slideshow_animation_type = ( ! empty( $settings['ere_featured_properties_two_animation_type'] ) ) ? $settings['ere_featured_properties_two_animation_type'] : "slide";
            ?>
