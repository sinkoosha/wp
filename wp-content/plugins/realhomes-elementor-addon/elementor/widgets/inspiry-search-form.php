...
//					'{{WRAPPER}} .rhea_collapsed_search_fields_inner .rhea_prop_search__option' => 'width: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .rhea_search_form_wrapper.rhea_buttons_bottom .rhea_search_form_button' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Fields Border Size Padding', 'realhomes-elementor-addon' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
						...
						if ( isset( $additional_fields ) && is_array( $additional_fields ) && ! empty( $additional_fields ) ) {
							...
							foreach ( $additional_fields as $additional_field ) {
								foreach ( $additional_field as $value ) {
									if ( in_array( 'search', $value['field_display'] ) ) {
