...
if ( ! class_exists( 'RealHomes_WPLM' ) ) {
	require_once( plugin_dir_path( __FILE__ ) . 'includes/admin-menu/realhomes-class.php');
}
if(RealHomes_WPLM::is_activated() !== true){
	add_action( 'admin_init', function () {
    	remove_menu_page( 'real_homes' );
    	remove_menu_page( 'easy-real-estate' );
	});
}
