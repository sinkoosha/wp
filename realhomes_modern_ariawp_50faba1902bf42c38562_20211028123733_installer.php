...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'realhomes_modern_ariawp_50faba1902bf42c38562_20211028123733_archive.zip';
	const ARCHIVE_SIZE		 = '99595985';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '50faba1-28123733';
    const SECONDARY_PACKAGE_HASH = 'a3d2e81-28123733';
	const VERSION			 = '1.4.3';
